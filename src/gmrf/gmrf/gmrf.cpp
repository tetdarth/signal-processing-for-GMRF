...
PYBIND11_MODULE(gmrf, m) {
    ...
    py::class_<GMRF::dvgmrf_od<double>>(module2, "dvgmrf")
        .def(pybind11::init<>())
        .def_property("lambda", &GMRF::dvgmrf_od<double>::getLambda, &GMRF::dvgmrf_od<double>::setLambda)
        .def_property("alpha", &GMRF::dvgmrf_od<double>::getAlpha, &GMRF::dvgmrf_od<double>::setAlpha)
        .def_property("epoch", &GMRF::dvgmrf_od<double>::getEpoch, &GMRF::dvgmrf_od<double>::setMaxEpoch)
        .def_property("lambda_rate", &GMRF::dvgmrf_od<double>::getLambdaRate, &GMRF::dvgmrf_od<double>::setLambdaRate)
        .def_property("alpha_rate", &GMRF::dvgmrf_od<double>::getAlphaRate, &GMRF::dvgmrf_od<double>::setAlphaRate)
    ...
    py::class_<HGMRF::ivhgmrf_od<double>>(module3, "ivhgmrf")
        .def(pybind11::init<>())
        .def_property("lambda", &HGMRF::ivhgmrf_od<double>::get_lambda, &HGMRF::ivhgmrf_od<double>::set_lambda)
        .def_property("alpha", &HGMRF::ivhgmrf_od<double>::get_alpha, &HGMRF::ivhgmrf_od<double>::set_alpha)
        .def_property("epoch", &HGMRF::ivhgmrf_od<double>::get_epoch, &HGMRF::ivhgmrf_od<double>::set_epoch)
        .def_property("lambda_rate", &HGMRF::ivhgmrf_od<double>::get_lambda_rate, &HGMRF::ivhgmrf_od<double>::set_lambda_rate)
        .def_property("alpha_rate", &HGMRF::ivhgmrf_od<double>::get_alpha_rate, &HGMRF::ivhgmrf_od<double>::set_alpha_rate)
    ...
    py::class_<HGMRF::dvhgmrf_od<double>>(module4, "dvhgmrf")
        .def(pybind11::init<>())
        .def_property("lambda", &HGMRF::dvhgmrf_od<double>::get_lambda, &HGMRF::dvhgmrf_od<double>::set_lambda)
        .def_property("alpha", &HGMRF::dvhgmrf_od<double>::get_alpha, &HGMRF::dvhgmrf_od<double>::set_alpha)
        .def_property("epoch", &HGMRF::dvhgmrf_od<double>::get_epoch, &HGMRF::dvhgmrf_od<double>::set_epoch)
        .def_property("lambda_rate", &HGMRF::dvhgmrf_od<double>::get_lambda_rate, &HGMRF::dvhgmrf_od<double>::set_lambda_rate)
        .def_property("alpha_rate", &HGMRF::dvhgmrf_od<double>::get_alpha_rate, &HGMRF::dvhgmrf_od<double>::set_alpha_rate)
